		...
		<div class="navbar navbar-inverse">
			...
			<div class="navbar-collapse collapse">
				<ul class="nav navbar-nav">
					<li><a href="new-task">Creer une tâche</a></li>
					<li><a href="all-tasks">Liste des Tâches</a></li>
				</ul>
			</div>
		</div>
	</div>
		...
		<c:when test="${mode == 'MODE_HOME'}">
			<div class="container" id="homeDiv">
				<div class="jumbotron text-center">
					<h1>Bienvenue au Gestionnaire de Tâches</h1>
				</div>
			</div>
		</c:when>
						...
						<tbody>
							<c:forEach var="task" items="${tasks}">
								<tr>
									...
									<td><a onclick="return confirm('Voulez vous vraiment supprimer la tâche?')" href="delete-task?id=${task.id}"><span><span class="glyphicon glyphicon-trash"></span></span></a></td>
